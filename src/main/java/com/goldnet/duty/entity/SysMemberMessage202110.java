...
/**
 * 
 * @TableName sys_member_message_202110
 */
@TableName(value ="sys_member_message_202110")
@Data
public class SysMemberMessage202110 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202110 other = (SysMemberMessage202110) that;
