...
/**
 * 
 * @TableName count_perion_days_lottery_202205
 */
@TableName(value ="count_perion_days_lottery_202205")
@Data
public class CountPerionDaysLottery202205 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202205 other = (CountPerionDaysLottery202205) that;
