...
/**
 * 
 * @TableName count_perion_days_lottery_202004
 */
@TableName(value ="count_perion_days_lottery_202004")
@Data
public class CountPerionDaysLottery202004 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202004 other = (CountPerionDaysLottery202004) that;
