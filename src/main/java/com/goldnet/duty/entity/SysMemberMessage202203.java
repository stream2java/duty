...
/**
 * 
 * @TableName sys_member_message_202203
 */
@TableName(value ="sys_member_message_202203")
@Data
public class SysMemberMessage202203 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202203 other = (SysMemberMessage202203) that;
