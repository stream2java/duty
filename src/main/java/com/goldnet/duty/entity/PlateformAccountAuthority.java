...
/**
 * 平台账号栏目表
 * @TableName plateform_account_authority
 */
@TableName(value ="plateform_account_authority")
@Data
public class PlateformAccountAuthority implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        PlateformAccountAuthority other = (PlateformAccountAuthority) that;
