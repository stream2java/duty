...
/**
 * 
 * @TableName count_perion_days_lottery_202107
 */
@TableName(value ="count_perion_days_lottery_202107")
@Data
public class CountPerionDaysLottery202107 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202107 other = (CountPerionDaysLottery202107) that;
