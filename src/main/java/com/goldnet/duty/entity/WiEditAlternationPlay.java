...
/**
 * 轮播管理编辑表
 * @TableName wi_edit_alternation_play
 */
@TableName(value ="wi_edit_alternation_play")
@Data
public class WiEditAlternationPlay implements Serializable {
    /**
     * 表Id
     */
    ...
    public boolean equals(Object that) {
        ...
        WiEditAlternationPlay other = (WiEditAlternationPlay) that;
