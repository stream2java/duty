...
/**
 * 
 * @TableName count_perion_days_lottery_202109
 */
@TableName(value ="count_perion_days_lottery_202109")
@Data
public class CountPerionDaysLottery202109 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202109 other = (CountPerionDaysLottery202109) that;
