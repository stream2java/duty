...
/**
 * 
 * @TableName count_perion_days_lottery_202012
 */
@TableName(value ="count_perion_days_lottery_202012")
@Data
public class CountPerionDaysLottery202012 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202012 other = (CountPerionDaysLottery202012) that;
