...
/**
 * 
 * @TableName count_perion_days_lottery_202007
 */
@TableName(value ="count_perion_days_lottery_202007")
@Data
public class CountPerionDaysLottery202007 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202007 other = (CountPerionDaysLottery202007) that;
