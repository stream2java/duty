...
/**
 * 
 * @TableName ms_archive_proportion
 */
@TableName(value ="ms_archive_proportion")
@Data
public class MsArchiveProportion implements Serializable {
    /**
     * ID
     */
    ...
    public boolean equals(Object that) {
        ...
        MsArchiveProportion other = (MsArchiveProportion) that;
