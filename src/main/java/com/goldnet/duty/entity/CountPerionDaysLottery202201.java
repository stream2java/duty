...
/**
 * 
 * @TableName count_perion_days_lottery_202201
 */
@TableName(value ="count_perion_days_lottery_202201")
@Data
public class CountPerionDaysLottery202201 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202201 other = (CountPerionDaysLottery202201) that;
