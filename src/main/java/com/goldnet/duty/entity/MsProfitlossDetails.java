...
/**
 * 派彩详情表
 * @TableName ms_profitloss_details
 */
@TableName(value ="ms_profitloss_details")
@Data
public class MsProfitlossDetails implements Serializable {
    /**
     * ID
     */
    ...
    public boolean equals(Object that) {
        ...
        MsProfitlossDetails other = (MsProfitlossDetails) that;
