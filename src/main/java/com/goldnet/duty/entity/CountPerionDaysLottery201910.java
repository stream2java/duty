...
/**
 * 
 * @TableName count_perion_days_lottery_201910
 */
@TableName(value ="count_perion_days_lottery_201910")
@Data
public class CountPerionDaysLottery201910 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery201910 other = (CountPerionDaysLottery201910) that;
