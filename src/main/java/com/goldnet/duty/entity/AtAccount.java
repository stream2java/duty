 ...
 */
@TableName(value ="at_account")
@Data
public class AtAccount implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    /**
     * 币种1人名币[4月16日作废该字段，使用currency_id，如果在此之前有使用该字段，统一修改]
     */
    ...
    /**
     * 【暂不使用】用于判断会员是否有保存过限额。默认为0 表示没有，1表示有。会员登陆时需将此保存到session。
     */
    ...
    public boolean equals(Object that) {
        ...
        AtAccount other = (AtAccount) that;
