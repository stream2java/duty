...
/**
 * 
 * @TableName sys_member_message_202202
 */
@TableName(value ="sys_member_message_202202")
@Data
public class SysMemberMessage202202 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202202 other = (SysMemberMessage202202) that;
