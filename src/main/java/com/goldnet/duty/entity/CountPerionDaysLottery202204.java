...
/**
 * 
 * @TableName count_perion_days_lottery_202204
 */
@TableName(value ="count_perion_days_lottery_202204")
@Data
public class CountPerionDaysLottery202204 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202204 other = (CountPerionDaysLottery202204) that;
