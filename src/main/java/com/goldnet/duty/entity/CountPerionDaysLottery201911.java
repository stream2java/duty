...
/**
 * 
 * @TableName count_perion_days_lottery_201911
 */
@TableName(value ="count_perion_days_lottery_201911")
@Data
public class CountPerionDaysLottery201911 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery201911 other = (CountPerionDaysLottery201911) that;
