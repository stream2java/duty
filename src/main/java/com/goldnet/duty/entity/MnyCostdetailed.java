...
/**
 * 费用明细表
 * @TableName mny_costdetailed
 */
@TableName(value ="mny_costdetailed")
@Data
public class MnyCostdetailed implements Serializable {
    /**
     * 费用明细表id
     */
    ...
    public boolean equals(Object that) {
        ...
        MnyCostdetailed other = (MnyCostdetailed) that;
