...
/**
 * 
 * @TableName count_perion_days_lottery_202011
 */
@TableName(value ="count_perion_days_lottery_202011")
@Data
public class CountPerionDaysLottery202011 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202011 other = (CountPerionDaysLottery202011) that;
