...
/**
 * 
 * @TableName sys_member_message_202101
 */
@TableName(value ="sys_member_message_202101")
@Data
public class SysMemberMessage202101 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202101 other = (SysMemberMessage202101) that;
