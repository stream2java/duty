...
/**
 * 用户单日彩种统计表
 * @TableName count_perion_days_lottery
 */
@TableName(value ="count_perion_days_lottery")
@Data
public class CountPerionDaysLottery implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery other = (CountPerionDaysLottery) that;
