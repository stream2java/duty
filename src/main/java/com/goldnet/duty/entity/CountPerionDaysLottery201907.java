...
/**
 * 
 * @TableName count_perion_days_lottery_201907
 */
@TableName(value ="count_perion_days_lottery_201907")
@Data
public class CountPerionDaysLottery201907 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery201907 other = (CountPerionDaysLottery201907) that;
