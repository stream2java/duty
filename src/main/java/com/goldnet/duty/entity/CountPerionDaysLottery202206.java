...
/**
 * 
 * @TableName count_perion_days_lottery_202206
 */
@TableName(value ="count_perion_days_lottery_202206")
@Data
public class CountPerionDaysLottery202206 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202206 other = (CountPerionDaysLottery202206) that;
