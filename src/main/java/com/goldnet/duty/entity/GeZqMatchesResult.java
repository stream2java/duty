...
/**
 * 体育 - 比赛结果表
 * @TableName ge_zq_matches_result
 */
@TableName(value ="ge_zq_matches_result")
@Data
public class GeZqMatchesResult implements Serializable {
    /**
     * 主键
     */
    @TableId(value = "matches_result_id")
    ...
    /**
     * 状态，0为新建，1为修改过，2为结算过，3腰斩（比赛被腰斩了没有比赛结果），4取消（比赛被取消了 没有比赛结果）
     */
    ...
    public boolean equals(Object that) {
        ...
        GeZqMatchesResult other = (GeZqMatchesResult) that;
