...
/**
 * 
 * @TableName sys_member_message_202206
 */
@TableName(value ="sys_member_message_202206")
@Data
public class SysMemberMessage202206 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202206 other = (SysMemberMessage202206) that;
