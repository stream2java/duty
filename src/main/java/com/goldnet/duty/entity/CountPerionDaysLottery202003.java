...
/**
 * 
 * @TableName count_perion_days_lottery_202003
 */
@TableName(value ="count_perion_days_lottery_202003")
@Data
public class CountPerionDaysLottery202003 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202003 other = (CountPerionDaysLottery202003) that;
