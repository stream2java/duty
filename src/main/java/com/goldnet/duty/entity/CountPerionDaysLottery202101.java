...
/**
 * 
 * @TableName count_perion_days_lottery_202101
 */
@TableName(value ="count_perion_days_lottery_202101")
@Data
public class CountPerionDaysLottery202101 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202101 other = (CountPerionDaysLottery202101) that;
