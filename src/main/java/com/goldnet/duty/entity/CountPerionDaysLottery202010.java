...
/**
 * 
 * @TableName count_perion_days_lottery_202010
 */
@TableName(value ="count_perion_days_lottery_202010")
@Data
public class CountPerionDaysLottery202010 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202010 other = (CountPerionDaysLottery202010) that;
