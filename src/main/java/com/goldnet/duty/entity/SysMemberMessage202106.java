...
/**
 * 
 * @TableName sys_member_message_202106
 */
@TableName(value ="sys_member_message_202106")
@Data
public class SysMemberMessage202106 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202106 other = (SysMemberMessage202106) that;
