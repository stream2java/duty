...
/**
 * 
 * @TableName count_perion_days_lottery_202203
 */
@TableName(value ="count_perion_days_lottery_202203")
@Data
public class CountPerionDaysLottery202203 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202203 other = (CountPerionDaysLottery202203) that;
