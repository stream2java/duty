...
/**
 * 
 * @TableName sys_member_message_202008
 */
@TableName(value ="sys_member_message_202008")
@Data
public class SysMemberMessage202008 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202008 other = (SysMemberMessage202008) that;
