...
/**
 * 
 * @TableName promotion_rebate_event_0404
 */
@TableName(value ="promotion_rebate_event_0404")
@Data
public class PromotionRebateEvent0404 implements Serializable {
    /**
     * 
     */
    @TableField(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        PromotionRebateEvent0404 other = (PromotionRebateEvent0404) that;
