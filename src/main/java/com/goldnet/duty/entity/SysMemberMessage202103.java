...
/**
 * 
 * @TableName sys_member_message_202103
 */
@TableName(value ="sys_member_message_202103")
@Data
public class SysMemberMessage202103 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202103 other = (SysMemberMessage202103) that;
