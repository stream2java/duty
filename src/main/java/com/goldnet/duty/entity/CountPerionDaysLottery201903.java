...
/**
 * 
 * @TableName count_perion_days_lottery_201903
 */
@TableName(value ="count_perion_days_lottery_201903")
@Data
public class CountPerionDaysLottery201903 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery201903 other = (CountPerionDaysLottery201903) that;
