...
/**
 * 
 * @TableName sys_member_message_202108
 */
@TableName(value ="sys_member_message_202108")
@Data
public class SysMemberMessage202108 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202108 other = (SysMemberMessage202108) that;
