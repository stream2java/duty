...
/**
 * 
 * @TableName mny_costdetaiied_old
 */
@TableName(value ="mny_costdetaiied_old")
@Data
public class MnyCostdetaiiedOld implements Serializable {
    /**
     * 
     */
    @TableId(value = "a_one")
    ...
    public boolean equals(Object that) {
        ...
        MnyCostdetaiiedOld other = (MnyCostdetaiiedOld) that;
