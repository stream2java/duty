...
/**
 * 
 * @TableName sys_member_message_202109
 */
@TableName(value ="sys_member_message_202109")
@Data
public class SysMemberMessage202109 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202109 other = (SysMemberMessage202109) that;
