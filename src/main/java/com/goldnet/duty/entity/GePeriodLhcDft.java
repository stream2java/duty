...
/**
 * 六合专用期数表
 * @TableName ge_period_lhc_dft
 */
@TableName(value ="ge_period_lhc_dft")
@Data
public class GePeriodLhcDft implements Serializable {
    /**
     * 期数Id
     */
    @TableId(value = "period_lhc_dft_id")
    private Object period_lhc_dft_id;
    ...
    public boolean equals(Object that) {
        ...
        GePeriodLhcDft other = (GePeriodLhcDft) that;
        return (this.getPeriod_lhc_dft_id() == null ? other.getPeriod_lhc_dft_id() == null : this.getPeriod_lhc_dft_id().equals(other.getPeriod_lhc_dft_id()))
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((getPeriod_lhc_dft_id() == null) ? 0 : getPeriod_lhc_dft_id().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", period_lhc_dft_id=").append(period_lhc_dft_id);
