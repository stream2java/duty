...
/**
 * 
 * @TableName count_perion_days_lottery_202111
 */
@TableName(value ="count_perion_days_lottery_202111")
@Data
public class CountPerionDaysLottery202111 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202111 other = (CountPerionDaysLottery202111) that;
