...
/**
 * 
 * @TableName count_perion_days_lottery_202104
 */
@TableName(value ="count_perion_days_lottery_202104")
@Data
public class CountPerionDaysLottery202104 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202104 other = (CountPerionDaysLottery202104) that;
