...
/**
 * 
 * @TableName tmp_apibettingdetail
 */
@TableName(value ="tmp_apibettingdetail")
@Data
public class TmpApibettingdetail implements Serializable {
    /**
     * 
     */
    @TableField(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        TmpApibettingdetail other = (TmpApibettingdetail) that;
