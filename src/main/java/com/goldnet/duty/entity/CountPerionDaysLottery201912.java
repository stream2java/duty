...
/**
 * 
 * @TableName count_perion_days_lottery_201912
 */
@TableName(value ="count_perion_days_lottery_201912")
@Data
public class CountPerionDaysLottery201912 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery201912 other = (CountPerionDaysLottery201912) that;
