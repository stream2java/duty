...
/**
 * 
 * @TableName count_perion_days_lottery_202001
 */
@TableName(value ="count_perion_days_lottery_202001")
@Data
public class CountPerionDaysLottery202001 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202001 other = (CountPerionDaysLottery202001) that;
