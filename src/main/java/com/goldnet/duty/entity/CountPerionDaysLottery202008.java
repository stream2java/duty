...
/**
 * 
 * @TableName count_perion_days_lottery_202008
 */
@TableName(value ="count_perion_days_lottery_202008")
@Data
public class CountPerionDaysLottery202008 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202008 other = (CountPerionDaysLottery202008) that;
