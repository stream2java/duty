...
/**
 * 
 * @TableName count_perion_days_lottery_202102
 */
@TableName(value ="count_perion_days_lottery_202102")
@Data
public class CountPerionDaysLottery202102 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202102 other = (CountPerionDaysLottery202102) that;
