...
/**
 * 所有投注详情
 * @TableName ty_betting_details
 */
@TableName(value ="ty_betting_details")
@Data
public class TyBettingDetails implements Serializable {
    /**
     * 主键
     */
    ...
    /**
     * Y赢N输如果是足球注单 本列请参考Odds表中的Who字段0跟1是主队，2跟3是客队
     */
    ...
    /**
     * ab盘标识 足球中 已结算的 表示结算的结果 0全输 1输一半 2平 3赢一半 4全赢 未结算的 2表示 被系统取消掉了 没有对冲记录 六合彩:用作保存当前年份的生肖 如: 蛇年:6; 马年:7;
     */
    ...
    /**
     * 投注项名称，如0-9,大，小，单，双 如果是足球注单请参考 足球赔率的 Type_Detail
     */
    ...
    /**
     * 体育投注是否混合过关 非混合过关都是0 是混合过关的主单是1 子单是2 拉霸机 0是正常投注 1是免费游戏的投注
     */
    ...
    /**
     * 体育混合过关时 子单查找主单的KEY电子x25用来表示人民币比例
     */
    @TableField(value = "parent_id")
    private Object parent_id;

    /**
     * 体育混合过关 表示还有几单未结算电子需要兑换积分的 用来表示积分兑换比例
     */
    ...
    public boolean equals(Object that) {
        ...
        TyBettingDetails other = (TyBettingDetails) that;
