...
/**
 * 
 * @TableName mny_merchant_extract_bank
 */
@TableName(value ="mny_merchant_extract_bank")
@Data
public class MnyMerchantExtractBank implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        MnyMerchantExtractBank other = (MnyMerchantExtractBank) that;
