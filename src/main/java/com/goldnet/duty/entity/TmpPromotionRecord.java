...
/**
 * 
 * @TableName tmp_promotion_record
 */
@TableName(value ="tmp_promotion_record")
@Data
public class TmpPromotionRecord implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        TmpPromotionRecord other = (TmpPromotionRecord) that;
