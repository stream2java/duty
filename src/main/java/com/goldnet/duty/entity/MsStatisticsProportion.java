...
/**
 * 
 * @TableName ms_statistics_proportion
 */
@TableName(value ="ms_statistics_proportion")
@Data
public class MsStatisticsProportion implements Serializable {
    /**
     * ID
     */
    @TableId(value = "archive_proportion_id")
    ...
    public boolean equals(Object that) {
        ...
        MsStatisticsProportion other = (MsStatisticsProportion) that;
