...
/**
 * 
 * @TableName sys_member_message_202011
 */
@TableName(value ="sys_member_message_202011")
@Data
public class SysMemberMessage202011 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202011 other = (SysMemberMessage202011) that;
