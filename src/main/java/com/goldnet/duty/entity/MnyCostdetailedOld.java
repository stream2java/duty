...
/**
 * 费用明细表
 * @TableName mny_costdetailed_old
 */
@TableName(value ="mny_costdetailed_old")
@Data
public class MnyCostdetailedOld implements Serializable {
    /**
     * 费用明细表id
     */
    ...
    public boolean equals(Object that) {
        ...
        MnyCostdetailedOld other = (MnyCostdetailedOld) that;
