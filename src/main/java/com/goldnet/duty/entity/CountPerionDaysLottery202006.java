...
/**
 * 
 * @TableName count_perion_days_lottery_202006
 */
@TableName(value ="count_perion_days_lottery_202006")
@Data
public class CountPerionDaysLottery202006 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202006 other = (CountPerionDaysLottery202006) that;
