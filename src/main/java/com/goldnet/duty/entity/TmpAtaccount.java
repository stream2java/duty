...
/**
 * 
 * @TableName tmp_ataccount
 */
@TableName(value ="tmp_ataccount")
@Data
public class TmpAtaccount implements Serializable {
    /**
     * 
     */
    @TableField(value = "id")
     ...
     * 
     */
    @TableField(value = "og_reg")
    private Object og_reg;

    /**
     * 
     */
    @TableField(value = "mg_reg")
    private Object mg_reg;
     ...
     * 
     */
    @TableField(value = "opus_reg")
    private Object opus_reg;

    /**
     * 
     */
    @TableField(value = "ibc_reg")
    private Object ibc_reg;

    /**
     * 
     */
    @TableField(value = "dios_reg")
    private Object dios_reg;

    /**
     * 
     */
    @TableField(value = "pt_reg")
    private Object pt_reg;
     ...
     * 
     */
    @TableField(value = "lebo_reg")
    private Object lebo_reg;

    /**
     * 
     */
    @TableField(value = "ogs_reg")
    private Object ogs_reg;

    /**
     * 
     */
    @TableField(value = "ab_reg")
    private Object ab_reg;
     ...
     * 
     */
    @TableField(value = "ogg_reg")
    private Object ogg_reg;
     ...
     * 
     */
    @TableField(value = "ds_reg")
    private Object ds_reg;
     ...
     * 
     */
    @TableField(value = "mwg_reg")
    private Object mwg_reg;
     ...
     * 
     */
    @TableField(value = "cp_reg")
    private Object cp_reg;

    /**
     * 
     */
    @TableField(value = "ty_reg")
    private Object ty_reg;

    /**
     * 
     */
    @TableField(value = "nmg_reg")
    private Object nmg_reg;

    /**
     * 
     */
    @TableField(value = "cmd_reg")
    private Object cmd_reg;

    /**
     * 
     */
    @TableField(value = "vg_reg")
    private Object vg_reg;

    /**
     * 
     */
    @TableField(value = "pp_reg")
    private Object pp_reg;

    /**
     * 
     */
    @TableField(value = "vgs_reg")
    private Object vgs_reg;

    /**
     * 
     */
    @TableField(value = "cq9_reg")
    private Object cq9_reg;
     ...
     * 
     */
    @TableField(value = "bc_reg")
    private Object bc_reg;

    /**
     * 
     */
    @TableField(value = "bg_reg")
    private Object bg_reg;

    /**
     * 
     */
    @TableField(value = "png_reg")
    private Object png_reg;

    /**
     * 
     */
    @TableField(value = "jdb_reg")
    private Object jdb_reg;
    ...
    public boolean equals(Object that) {
        ...
        TmpAtaccount other = (TmpAtaccount) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getOg_reg() == null ? other.getOg_reg() == null : this.getOg_reg().equals(other.getOg_reg()))
            && (this.getMg_reg() == null ? other.getMg_reg() == null : this.getMg_reg().equals(other.getMg_reg()))
            ...
            && (this.getOpus_reg() == null ? other.getOpus_reg() == null : this.getOpus_reg().equals(other.getOpus_reg()))
            && (this.getIbc_reg() == null ? other.getIbc_reg() == null : this.getIbc_reg().equals(other.getIbc_reg()))
            && (this.getDios_reg() == null ? other.getDios_reg() == null : this.getDios_reg().equals(other.getDios_reg()))
            && (this.getPt_reg() == null ? other.getPt_reg() == null : this.getPt_reg().equals(other.getPt_reg()))
            ...
            && (this.getLebo_reg() == null ? other.getLebo_reg() == null : this.getLebo_reg().equals(other.getLebo_reg()))
            && (this.getOgs_reg() == null ? other.getOgs_reg() == null : this.getOgs_reg().equals(other.getOgs_reg()))
            && (this.getAb_reg() == null ? other.getAb_reg() == null : this.getAb_reg().equals(other.getAb_reg()))
            && (this.getOg_login_status() == null ? other.getOg_login_status() == null : this.getOg_login_status().equals(other.getOg_login_status()))
            && (this.getOgg_reg() == null ? other.getOgg_reg() == null : this.getOgg_reg().equals(other.getOgg_reg()))
            ...
            && (this.getDs_reg() == null ? other.getDs_reg() == null : this.getDs_reg().equals(other.getDs_reg()))
            ...
            && (this.getMwg_reg() == null ? other.getMwg_reg() == null : this.getMwg_reg().equals(other.getMwg_reg()))
            ...
            && (this.getCp_reg() == null ? other.getCp_reg() == null : this.getCp_reg().equals(other.getCp_reg()))
            && (this.getTy_reg() == null ? other.getTy_reg() == null : this.getTy_reg().equals(other.getTy_reg()))
            && (this.getNmg_reg() == null ? other.getNmg_reg() == null : this.getNmg_reg().equals(other.getNmg_reg()))
            && (this.getCmd_reg() == null ? other.getCmd_reg() == null : this.getCmd_reg().equals(other.getCmd_reg()))
            && (this.getVg_reg() == null ? other.getVg_reg() == null : this.getVg_reg().equals(other.getVg_reg()))
            && (this.getPp_reg() == null ? other.getPp_reg() == null : this.getPp_reg().equals(other.getPp_reg()))
            && (this.getVgs_reg() == null ? other.getVgs_reg() == null : this.getVgs_reg().equals(other.getVgs_reg()))
            && (this.getCq9_reg() == null ? other.getCq9_reg() == null : this.getCq9_reg().equals(other.getCq9_reg()))
            ...
            && (this.getBc_reg() == null ? other.getBc_reg() == null : this.getBc_reg().equals(other.getBc_reg()))
            && (this.getBg_reg() == null ? other.getBg_reg() == null : this.getBg_reg().equals(other.getBg_reg()))
            && (this.getPng_reg() == null ? other.getPng_reg() == null : this.getPng_reg().equals(other.getPng_reg()))
            && (this.getJdb_reg() == null ? other.getJdb_reg() == null : this.getJdb_reg().equals(other.getJdb_reg()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getOg_reg() == null) ? 0 : getOg_reg().hashCode());
        result = prime * result + ((getMg_reg() == null) ? 0 : getMg_reg().hashCode());
        result = prime * result + ((getDraw_money_max_limit() == null) ? 0 : getDraw_money_max_limit().hashCode());
        result = prime * result + ((getOpus_reg() == null) ? 0 : getOpus_reg().hashCode());
        result = prime * result + ((getIbc_reg() == null) ? 0 : getIbc_reg().hashCode());
        result = prime * result + ((getDios_reg() == null) ? 0 : getDios_reg().hashCode());
        result = prime * result + ((getPt_reg() == null) ? 0 : getPt_reg().hashCode());
        ...
        result = prime * result + ((getLebo_reg() == null) ? 0 : getLebo_reg().hashCode());
        result = prime * result + ((getOgs_reg() == null) ? 0 : getOgs_reg().hashCode());
        result = prime * result + ((getAb_reg() == null) ? 0 : getAb_reg().hashCode());
        result = prime * result + ((getOg_login_status() == null) ? 0 : getOg_login_status().hashCode());
        result = prime * result + ((getOgg_reg() == null) ? 0 : getOgg_reg().hashCode());
        ...
        result = prime * result + ((getDs_reg() == null) ? 0 : getDs_reg().hashCode());
        ...
        result = prime * result + ((getMwg_reg() == null) ? 0 : getMwg_reg().hashCode());
        result = prime * result + ((getRapid_money_max_limit() == null) ? 0 : getRapid_money_max_limit().hashCode());
        result = prime * result + ((getCp_reg() == null) ? 0 : getCp_reg().hashCode());
        result = prime * result + ((getTy_reg() == null) ? 0 : getTy_reg().hashCode());
        result = prime * result + ((getNmg_reg() == null) ? 0 : getNmg_reg().hashCode());
        result = prime * result + ((getCmd_reg() == null) ? 0 : getCmd_reg().hashCode());
        result = prime * result + ((getVg_reg() == null) ? 0 : getVg_reg().hashCode());
        result = prime * result + ((getPp_reg() == null) ? 0 : getPp_reg().hashCode());
        result = prime * result + ((getVgs_reg() == null) ? 0 : getVgs_reg().hashCode());
        result = prime * result + ((getCq9_reg() == null) ? 0 : getCq9_reg().hashCode());
        ...
        result = prime * result + ((getBc_reg() == null) ? 0 : getBc_reg().hashCode());
        result = prime * result + ((getBg_reg() == null) ? 0 : getBg_reg().hashCode());
        result = prime * result + ((getPng_reg() == null) ? 0 : getPng_reg().hashCode());
        result = prime * result + ((getJdb_reg() == null) ? 0 : getJdb_reg().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", og_reg=").append(og_reg);
        sb.append(", mg_reg=").append(mg_reg);
        sb.append(", draw_money_max_limit=").append(draw_money_max_limit);
        sb.append(", opus_reg=").append(opus_reg);
        sb.append(", ibc_reg=").append(ibc_reg);
        sb.append(", dios_reg=").append(dios_reg);
        sb.append(", pt_reg=").append(pt_reg);
        sb.append(", mg_password=").append(mg_password);
        sb.append(", pt_password=").append(pt_password);
        sb.append(", lebo_reg=").append(lebo_reg);
        sb.append(", ogs_reg=").append(ogs_reg);
        sb.append(", ab_reg=").append(ab_reg);
        sb.append(", og_login_status=").append(og_login_status);
        sb.append(", ogg_reg=").append(ogg_reg);
        ...
        sb.append(", ds_reg=").append(ds_reg);
        ...
        sb.append(", mwg_reg=").append(mwg_reg);
        sb.append(", rapid_money_max_limit=").append(rapid_money_max_limit);
        sb.append(", cp_reg=").append(cp_reg);
        sb.append(", ty_reg=").append(ty_reg);
        sb.append(", nmg_reg=").append(nmg_reg);
        sb.append(", cmd_reg=").append(cmd_reg);
        sb.append(", vg_reg=").append(vg_reg);
        sb.append(", pp_reg=").append(pp_reg);
        sb.append(", vgs_reg=").append(vgs_reg);
        sb.append(", cq9_reg=").append(cq9_reg);
        sb.append(", cp_parterner=").append(cp_parterner);
        sb.append(", cp_sign=").append(cp_sign);
        sb.append(", cp_web_site=").append(cp_web_site);
        sb.append(", bc_reg=").append(bc_reg);
        sb.append(", bg_reg=").append(bg_reg);
        sb.append(", png_reg=").append(png_reg);
        sb.append(", jdb_reg=").append(jdb_reg);
