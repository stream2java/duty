...
/**
 * 龙虎斗局详情
 * @TableName ge_video_dragon_tiger
 */
@TableName(value ="ge_video_dragon_tiger")
@Data
public class GeVideoDragonTiger implements Serializable {
    /**
     * 局ID
     */
     ...
     * 龙点数
     */
    @TableField(value = "dragon_point")
    private Object dragon_point;

    /**
     * 虎点数
     */
    @TableField(value = "tiger_point")
    private Object tiger_point;

    /**
     * 龙牌
     */
    @TableField(value = "dragon_poker")
    private String dragon_poker;

    /**
     * 虎牌
     */
    @TableField(value = "tiger_poker")
    private String tiger_poker;

    /**
     * 龙红黑,0黑1红
     */
    @TableField(value = "dragon_bor")
    private Object dragon_bor;

    /**
     * 龙单双,0双,1单
     */
    @TableField(value = "dragon_sod")
    private Object dragon_sod;

    /**
     * 虎红黑,0黑1红
     */
    @TableField(value = "tiger_bor")
    private Object tiger_bor;

    /**
     * 虎单双,0双1单
     */
    @TableField(value = "tiger_sod")
    private Object tiger_sod;
    ...
    public boolean equals(Object that) {
        ...
        GeVideoDragonTiger other = (GeVideoDragonTiger) that;
        return (this.getInning_id() == null ? other.getInning_id() == null : this.getInning_id().equals(other.getInning_id()))
            ...
            && (this.getDragon_point() == null ? other.getDragon_point() == null : this.getDragon_point().equals(other.getDragon_point()))
            && (this.getTiger_point() == null ? other.getTiger_point() == null : this.getTiger_point().equals(other.getTiger_point()))
            && (this.getDragon_poker() == null ? other.getDragon_poker() == null : this.getDragon_poker().equals(other.getDragon_poker()))
            && (this.getTiger_poker() == null ? other.getTiger_poker() == null : this.getTiger_poker().equals(other.getTiger_poker()))
            && (this.getDragon_bor() == null ? other.getDragon_bor() == null : this.getDragon_bor().equals(other.getDragon_bor()))
            && (this.getDragon_sod() == null ? other.getDragon_sod() == null : this.getDragon_sod().equals(other.getDragon_sod()))
            && (this.getTiger_bor() == null ? other.getTiger_bor() == null : this.getTiger_bor().equals(other.getTiger_bor()))
            && (this.getTiger_sod() == null ? other.getTiger_sod() == null : this.getTiger_sod().equals(other.getTiger_sod()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDragon_point() == null) ? 0 : getDragon_point().hashCode());
        result = prime * result + ((getTiger_point() == null) ? 0 : getTiger_point().hashCode());
        result = prime * result + ((getDragon_poker() == null) ? 0 : getDragon_poker().hashCode());
        result = prime * result + ((getTiger_poker() == null) ? 0 : getTiger_poker().hashCode());
        result = prime * result + ((getDragon_bor() == null) ? 0 : getDragon_bor().hashCode());
        result = prime * result + ((getDragon_sod() == null) ? 0 : getDragon_sod().hashCode());
        result = prime * result + ((getTiger_bor() == null) ? 0 : getTiger_bor().hashCode());
        result = prime * result + ((getTiger_sod() == null) ? 0 : getTiger_sod().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", dragon_point=").append(dragon_point);
        sb.append(", tiger_point=").append(tiger_point);
        sb.append(", dragon_poker=").append(dragon_poker);
        sb.append(", tiger_poker=").append(tiger_poker);
        sb.append(", dragon_bor=").append(dragon_bor);
        sb.append(", dragon_sod=").append(dragon_sod);
        sb.append(", tiger_bor=").append(tiger_bor);
        sb.append(", tiger_sod=").append(tiger_sod);
