...
/**
 * 
 * @TableName regedit_blacklist
 */
@TableName(value ="regedit_blacklist")
@Data
public class RegeditBlacklist implements Serializable {
    /**
     * 流水id
     */
    @TableField(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        RegeditBlacklist other = (RegeditBlacklist) that;
