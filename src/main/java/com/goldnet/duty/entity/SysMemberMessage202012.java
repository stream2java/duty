...
/**
 * 
 * @TableName sys_member_message_202012
 */
@TableName(value ="sys_member_message_202012")
@Data
public class SysMemberMessage202012 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202012 other = (SysMemberMessage202012) that;
