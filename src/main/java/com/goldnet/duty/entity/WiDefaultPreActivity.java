...
/**
 * 优惠活动正在使用表
 * @TableName wi_default_pre_activity
 */
@TableName(value ="wi_default_pre_activity")
@Data
public class WiDefaultPreActivity implements Serializable {
    /**
     * 表id
     */
    ...
    public boolean equals(Object that) {
        ...
        WiDefaultPreActivity other = (WiDefaultPreActivity) that;
