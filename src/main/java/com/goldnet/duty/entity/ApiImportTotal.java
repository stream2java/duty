...
/**
 * 注单导入汇总表
 * @TableName api_import_total
 */
@TableName(value ="api_import_total")
@Data
public class ApiImportTotal implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        ApiImportTotal other = (ApiImportTotal) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getIs_collect() == null ? other.getIs_collect() == null : this.getIs_collect().equals(other.getIs_collect()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getIs_collect() == null) ? 0 : getIs_collect().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", is_collect=").append(is_collect);
