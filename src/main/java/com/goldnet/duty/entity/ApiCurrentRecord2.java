...
/**
 * 
 * @TableName api_current_record2
 */
@TableName(value ="api_current_record2")
@Data
public class ApiCurrentRecord2 implements Serializable {
    /**
     * 往来记录id
     */
    ...
    public boolean equals(Object that) {
        ...
        ApiCurrentRecord2 other = (ApiCurrentRecord2) that;
