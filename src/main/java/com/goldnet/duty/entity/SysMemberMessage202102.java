...
/**
 * 
 * @TableName sys_member_message_202102
 */
@TableName(value ="sys_member_message_202102")
@Data
public class SysMemberMessage202102 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202102 other = (SysMemberMessage202102) that;
