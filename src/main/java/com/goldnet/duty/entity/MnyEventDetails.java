...
/**
 * 
 * @TableName mny_event_details
 */
@TableName(value ="mny_event_details")
@Data
public class MnyEventDetails implements Serializable {
    /**
     * 优惠统计返水明细表id
     */
    ...
    public boolean equals(Object that) {
        ...
        MnyEventDetails other = (MnyEventDetails) that;
