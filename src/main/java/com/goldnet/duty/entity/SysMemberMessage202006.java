...
/**
 * 
 * @TableName sys_member_message_202006
 */
@TableName(value ="sys_member_message_202006")
@Data
public class SysMemberMessage202006 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202006 other = (SysMemberMessage202006) that;
