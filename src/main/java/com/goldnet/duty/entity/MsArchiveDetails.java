...
/**
 * 存档详情表
 * @TableName ms_archive_details
 */
@TableName(value ="ms_archive_details")
@Data
public class MsArchiveDetails implements Serializable {
    /**
     * ID
     */
    ...
    public boolean equals(Object that) {
        ...
        MsArchiveDetails other = (MsArchiveDetails) that;
