...
/**
 * 
 * @TableName tps_event_details
 */
@TableName(value ="tps_event_details")
@Data
public class TpsEventDetails implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        TpsEventDetails other = (TpsEventDetails) that;
