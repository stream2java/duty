...
/**
 * 
 * @TableName count_perion_days_lottery_202105
 */
@TableName(value ="count_perion_days_lottery_202105")
@Data
public class CountPerionDaysLottery202105 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202105 other = (CountPerionDaysLottery202105) that;
