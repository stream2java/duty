...
/**
 * 
 * @TableName count_perion_days_lottery_202202
 */
@TableName(value ="count_perion_days_lottery_202202")
@Data
public class CountPerionDaysLottery202202 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202202 other = (CountPerionDaysLottery202202) that;
