...
/**
 * 用于监控我们的会员资料表的变更情况，会对update和delete操作进行触发进来
 * @TableName at_member_message_trg
 */
@TableName(value ="at_member_message_trg")
@Data
public class AtMemberMessageTrg implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        AtMemberMessageTrg other = (AtMemberMessageTrg) that;
