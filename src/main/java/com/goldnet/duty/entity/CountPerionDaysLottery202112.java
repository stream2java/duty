...
/**
 * 
 * @TableName count_perion_days_lottery_202112
 */
@TableName(value ="count_perion_days_lottery_202112")
@Data
public class CountPerionDaysLottery202112 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202112 other = (CountPerionDaysLottery202112) that;
