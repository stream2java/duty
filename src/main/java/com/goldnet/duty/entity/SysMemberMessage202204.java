...
/**
 * 
 * @TableName sys_member_message_202204
 */
@TableName(value ="sys_member_message_202204")
@Data
public class SysMemberMessage202204 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202204 other = (SysMemberMessage202204) that;
