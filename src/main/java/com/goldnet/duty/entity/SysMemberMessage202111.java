...
/**
 * 
 * @TableName sys_member_message_202111
 */
@TableName(value ="sys_member_message_202111")
@Data
public class SysMemberMessage202111 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202111 other = (SysMemberMessage202111) that;
