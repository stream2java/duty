...
/**
 * 
 * @TableName tmp_promotion_report_record_month
 */
@TableName(value ="tmp_promotion_report_record_month")
@Data
public class TmpPromotionReportRecordMonth implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
     ...
     * 
     */
    @TableField(value = "statistics_month")
    ...
    public boolean equals(Object that) {
        ...
        TmpPromotionReportRecordMonth other = (TmpPromotionReportRecordMonth) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getStatistics_month() == null ? other.getStatistics_month() == null : this.getStatistics_month().equals(other.getStatistics_month()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getStatistics_month() == null) ? 0 : getStatistics_month().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", statistics_month=").append(statistics_month);
