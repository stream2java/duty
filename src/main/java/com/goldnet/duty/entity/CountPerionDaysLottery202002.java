...
/**
 * 
 * @TableName count_perion_days_lottery_202002
 */
@TableName(value ="count_perion_days_lottery_202002")
@Data
public class CountPerionDaysLottery202002 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202002 other = (CountPerionDaysLottery202002) that;
