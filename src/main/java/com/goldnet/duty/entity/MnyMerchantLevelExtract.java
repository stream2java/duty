...
/**
 * 商家号与层级关联表
 * @TableName mny_merchant_level_extract
 */
@TableName(value ="mny_merchant_level_extract")
@Data
public class MnyMerchantLevelExtract implements Serializable {
    /**
     * ID
     */
    @TableField(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        MnyMerchantLevelExtract other = (MnyMerchantLevelExtract) that;
