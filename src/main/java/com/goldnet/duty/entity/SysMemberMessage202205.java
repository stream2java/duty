...
/**
 * 
 * @TableName sys_member_message_202205
 */
@TableName(value ="sys_member_message_202205")
@Data
public class SysMemberMessage202205 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202205 other = (SysMemberMessage202205) that;
