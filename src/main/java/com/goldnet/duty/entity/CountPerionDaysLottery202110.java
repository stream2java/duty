...
/**
 * 
 * @TableName count_perion_days_lottery_202110
 */
@TableName(value ="count_perion_days_lottery_202110")
@Data
public class CountPerionDaysLottery202110 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202110 other = (CountPerionDaysLottery202110) that;
