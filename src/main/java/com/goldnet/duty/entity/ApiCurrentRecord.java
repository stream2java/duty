...
/**
 * 
 * @TableName api_current_record
 */
@TableName(value ="api_current_record")
@Data
public class ApiCurrentRecord implements Serializable {
    /**
     * 往来记录id
     */
    ...
    public boolean equals(Object that) {
        ...
        ApiCurrentRecord other = (ApiCurrentRecord) that;
