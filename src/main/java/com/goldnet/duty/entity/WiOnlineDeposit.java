...
/**
 * 线上存款
 * @TableName wi_online_deposit
 */
@TableName(value ="wi_online_deposit")
@Data
public class WiOnlineDeposit implements Serializable {
    /**
     * 线上存款id
     */
     ...
     * 横版app_内容
     */
    @TableField(value = "hbapp_context_sim")
    private String hbapp_context_sim;
    ...
    public boolean equals(Object that) {
        ...
        WiOnlineDeposit other = (WiOnlineDeposit) that;
        return (this.getOnline_deposit_id() == null ? other.getOnline_deposit_id() == null : this.getOnline_deposit_id().equals(other.getOnline_deposit_id()))
            ...
            && (this.getHbapp_context_sim() == null ? other.getHbapp_context_sim() == null : this.getHbapp_context_sim().equals(other.getHbapp_context_sim()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getHbapp_context_sim() == null) ? 0 : getHbapp_context_sim().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", hbapp_context_sim=").append(hbapp_context_sim);
