...
/**
 * 
 * @TableName mny_costdetailed_error_foundtime
 */
@TableName(value ="mny_costdetailed_error_foundtime")
@Data
public class MnyCostdetailedErrorFoundtime implements Serializable {
    /**
     * 
     */
    @TableField(value = "costdetailed_id")
    ...
    public boolean equals(Object that) {
        ...
        MnyCostdetailedErrorFoundtime other = (MnyCostdetailedErrorFoundtime) that;
