...
/**
 * 
 * @TableName count_perion_days_lottery_201901
 */
@TableName(value ="count_perion_days_lottery_201901")
@Data
public class CountPerionDaysLottery201901 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery201901 other = (CountPerionDaysLottery201901) that;
