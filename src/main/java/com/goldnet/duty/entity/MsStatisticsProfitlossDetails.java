...
/**
 * 派彩详情表
 * @TableName ms_statistics_profitloss_details
 */
@TableName(value ="ms_statistics_profitloss_details")
@Data
public class MsStatisticsProfitlossDetails implements Serializable {
    /**
     * ID
     */
    @TableId(value = "profitloss_details_id")
    ...
    public boolean equals(Object that) {
        ...
        MsStatisticsProfitlossDetails other = (MsStatisticsProfitlossDetails) that;
