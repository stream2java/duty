...
/**
 * 默认 赔率
 * @TableName ge_default_odds
 */
@TableName(value ="ge_default_odds")
@Data
public class GeDefaultOdds implements Serializable {
    /**
     * uuid主键
     */
    @TableId(value = "default_id")
    ...
    public boolean equals(Object that) {
        ...
        GeDefaultOdds other = (GeDefaultOdds) that;
        return (this.getDefault_id() == null ? other.getDefault_id() == null : this.getDefault_id().equals(other.getDefault_id()))
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((getDefault_id() == null) ? 0 : getDefault_id().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", default_id=").append(default_id);
