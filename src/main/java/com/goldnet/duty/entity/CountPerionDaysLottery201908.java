...
/**
 * 
 * @TableName count_perion_days_lottery_201908
 */
@TableName(value ="count_perion_days_lottery_201908")
@Data
public class CountPerionDaysLottery201908 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery201908 other = (CountPerionDaysLottery201908) that;
