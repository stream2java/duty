...
/**
 * 
 * @TableName sys_member_message_202201
 */
@TableName(value ="sys_member_message_202201")
@Data
public class SysMemberMessage202201 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202201 other = (SysMemberMessage202201) that;
