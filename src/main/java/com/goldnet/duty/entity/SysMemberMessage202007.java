...
/**
 * 
 * @TableName sys_member_message_202007
 */
@TableName(value ="sys_member_message_202007")
@Data
public class SysMemberMessage202007 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202007 other = (SysMemberMessage202007) that;
