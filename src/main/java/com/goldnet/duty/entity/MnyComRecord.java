...
/**
 * 公司入款记录表
 * @TableName mny_com_record
 */
@TableName(value ="mny_com_record")
@Data
public class MnyComRecord implements Serializable {
    /**
     * 公司入款记录id
     */
    @TableId(value = "com_record_id")
    ...
    public boolean equals(Object that) {
        ...
        MnyComRecord other = (MnyComRecord) that;
