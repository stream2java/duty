...
/**
 * 
 * @TableName count_perion_days_lottery_202106
 */
@TableName(value ="count_perion_days_lottery_202106")
@Data
public class CountPerionDaysLottery202106 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202106 other = (CountPerionDaysLottery202106) that;
