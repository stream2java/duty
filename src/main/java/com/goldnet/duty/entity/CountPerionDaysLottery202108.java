...
/**
 * 
 * @TableName count_perion_days_lottery_202108
 */
@TableName(value ="count_perion_days_lottery_202108")
@Data
public class CountPerionDaysLottery202108 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202108 other = (CountPerionDaysLottery202108) that;
