...
/**
 * 
 * @TableName tpe_at_current_record_trg
 */
@TableName(value ="tpe_at_current_record_trg")
@Data
public class TpeAtCurrentRecordTrg implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        TpeAtCurrentRecordTrg other = (TpeAtCurrentRecordTrg) that;
