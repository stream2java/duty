...
/**
 * 
 * @TableName sys_member_message_202112
 */
@TableName(value ="sys_member_message_202112")
@Data
public class SysMemberMessage202112 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202112 other = (SysMemberMessage202112) that;
