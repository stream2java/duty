...
/**
 * 
 * @TableName promotion_profit_rebate_event
 */
@TableName(value ="promotion_profit_rebate_event")
@Data
public class PromotionProfitRebateEvent implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
     ...
     * 挂账佣金人数
     */
    @TableField(value = "ledger_total_account")
    private Object ledger_total_account;

    /**
     * 挂账佣金金额
     */
    @TableField(value = "ledger_total_amount")
    private BigDecimal ledger_total_amount;
     ...
     * 清零佣金人数
     */
    @TableField(value = "clean_total_account")
    private Object clean_total_account;

    /**
     * 清零佣金金额
     */
    @TableField(value = "clean_total_amount")
    private BigDecimal clean_total_amount;
    ...
    public boolean equals(Object that) {
        ...
        PromotionProfitRebateEvent other = (PromotionProfitRebateEvent) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getLedger_total_account() == null ? other.getLedger_total_account() == null : this.getLedger_total_account().equals(other.getLedger_total_account()))
            && (this.getLedger_total_amount() == null ? other.getLedger_total_amount() == null : this.getLedger_total_amount().equals(other.getLedger_total_amount()))
            ...
            && (this.getClean_total_account() == null ? other.getClean_total_account() == null : this.getClean_total_account().equals(other.getClean_total_account()))
            && (this.getClean_total_amount() == null ? other.getClean_total_amount() == null : this.getClean_total_amount().equals(other.getClean_total_amount()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getLedger_total_account() == null) ? 0 : getLedger_total_account().hashCode());
        result = prime * result + ((getLedger_total_amount() == null) ? 0 : getLedger_total_amount().hashCode());
        ...
        result = prime * result + ((getClean_total_account() == null) ? 0 : getClean_total_account().hashCode());
        result = prime * result + ((getClean_total_amount() == null) ? 0 : getClean_total_amount().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", ledger_total_account=").append(ledger_total_account);
        sb.append(", ledger_total_amount=").append(ledger_total_amount);
        ...
        sb.append(", clean_total_account=").append(clean_total_account);
        sb.append(", clean_total_amount=").append(clean_total_amount);
