...
/**
 * 
 * @TableName count_perion_days_lottery_202009
 */
@TableName(value ="count_perion_days_lottery_202009")
@Data
public class CountPerionDaysLottery202009 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202009 other = (CountPerionDaysLottery202009) that;
