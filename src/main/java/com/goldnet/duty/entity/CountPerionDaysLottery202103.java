...
/**
 * 
 * @TableName count_perion_days_lottery_202103
 */
@TableName(value ="count_perion_days_lottery_202103")
@Data
public class CountPerionDaysLottery202103 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery202103 other = (CountPerionDaysLottery202103) that;
