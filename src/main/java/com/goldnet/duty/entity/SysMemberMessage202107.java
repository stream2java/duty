...
/**
 * 
 * @TableName sys_member_message_202107
 */
@TableName(value ="sys_member_message_202107")
@Data
public class SysMemberMessage202107 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202107 other = (SysMemberMessage202107) that;
