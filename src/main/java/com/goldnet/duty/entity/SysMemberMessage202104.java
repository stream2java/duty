...
/**
 * 
 * @TableName sys_member_message_202104
 */
@TableName(value ="sys_member_message_202104")
@Data
public class SysMemberMessage202104 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202104 other = (SysMemberMessage202104) that;
