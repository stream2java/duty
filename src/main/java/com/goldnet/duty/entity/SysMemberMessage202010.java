...
/**
 * 
 * @TableName sys_member_message_202010
 */
@TableName(value ="sys_member_message_202010")
@Data
public class SysMemberMessage202010 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        SysMemberMessage202010 other = (SysMemberMessage202010) that;
