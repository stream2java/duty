...
/**
 * 
 * @TableName count_perion_days_lottery_201904
 */
@TableName(value ="count_perion_days_lottery_201904")
@Data
public class CountPerionDaysLottery201904 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery201904 other = (CountPerionDaysLottery201904) that;
