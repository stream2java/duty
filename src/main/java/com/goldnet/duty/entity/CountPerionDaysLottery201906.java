...
/**
 * 
 * @TableName count_perion_days_lottery_201906
 */
@TableName(value ="count_perion_days_lottery_201906")
@Data
public class CountPerionDaysLottery201906 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery201906 other = (CountPerionDaysLottery201906) that;
