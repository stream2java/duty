...
/**
 * 
 * @TableName tmp_api_detail_login_log
 */
@TableName(value ="tmp_api_detail_login_log")
@Data
public class TmpApiDetailLoginLog implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        TmpApiDetailLoginLog other = (TmpApiDetailLoginLog) that;
        return (this.getAccount1() == null ? other.getAccount1() == null : this.getAccount1().equals(other.getAccount1()))
