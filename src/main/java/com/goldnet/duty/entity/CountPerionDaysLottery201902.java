...
/**
 * 
 * @TableName count_perion_days_lottery_201902
 */
@TableName(value ="count_perion_days_lottery_201902")
@Data
public class CountPerionDaysLottery201902 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery201902 other = (CountPerionDaysLottery201902) that;
