...
/**
 * 
 * @TableName count_perion_days_lottery_201909
 */
@TableName(value ="count_perion_days_lottery_201909")
@Data
public class CountPerionDaysLottery201909 implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        CountPerionDaysLottery201909 other = (CountPerionDaysLottery201909) that;
