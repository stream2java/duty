...
/**
 * 报表历史记录月份表
 * @TableName promotion_report_record_month
 */
@TableName(value ="promotion_report_record_month")
@Data
public class PromotionReportRecordMonth implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        PromotionReportRecordMonth other = (PromotionReportRecordMonth) that;
