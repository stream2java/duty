...
/**
 * 团队报表实时汇总表
 * @TableName promotion_report_record_es
 */
@TableName(value ="promotion_report_record_es")
@Data
public class PromotionReportRecordEs implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        PromotionReportRecordEs other = (PromotionReportRecordEs) that;
