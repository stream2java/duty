...
/**
 * 
 * @TableName at_current_record_temp
 */
@TableName(value ="at_current_record_temp")
@Data
public class AtCurrentRecordTemp implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        AtCurrentRecordTemp other = (AtCurrentRecordTemp) that;
