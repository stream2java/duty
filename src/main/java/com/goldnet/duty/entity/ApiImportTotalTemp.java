...
/**
 * 注单导入汇总表
 * @TableName api_import_total_temp
 */
@TableName(value ="api_import_total_temp")
@Data
public class ApiImportTotalTemp implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        ApiImportTotalTemp other = (ApiImportTotalTemp) that;
