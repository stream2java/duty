...
/**
 * 浮动图管理正在使用表
 * @TableName wi_default_float_pic
 */
@TableName(value ="wi_default_float_pic")
@Data
public class WiDefaultFloatPic implements Serializable {
    /**
     * 浮动图id
     */
    ...
    public boolean equals(Object that) {
        ...
        WiDefaultFloatPic other = (WiDefaultFloatPic) that;
