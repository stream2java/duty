...
/**
 * 
 * @TableName tmp_promotion_report_record
 */
@TableName(value ="tmp_promotion_report_record")
@Data
public class TmpPromotionReportRecord implements Serializable {
    /**
     * 
     */
    @TableId(value = "id")
    ...
    public boolean equals(Object that) {
        ...
        TmpPromotionReportRecord other = (TmpPromotionReportRecord) that;
